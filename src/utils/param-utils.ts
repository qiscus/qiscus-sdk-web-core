...
export const isReqString = (item: any) => {
  ...
  return compose(
    msg,
    every(is.not.null, is.not.undefined, is.string)
  )
}
export const isReqNumber = (item: any) => {
  ...
  return compose(
    msg,
    every(is.not.null, is.not.undefined, is.number)
  )
}
export const isReqBoolean = (item: any) => {
  ...
  return compose(
    msg,
    every(is.not.null, is.not.undefined, is.boolean)
  )
}
export const isReqJson = (item: any) => {
  ...
  return compose(
    msg,
    every(is.not.null, is.not.undefined, is.json)
  )
}
...
export const isReqArrayOfStringOrNumber = (item: any) => {
  ...
  return compose(
    msg,
    every(is.not.null, is.not.undefined, is.array, some(is.all.number, is.all.string))
  )
}
...
export const isOptArrayString = (item: any) => {
  ...
  return compose(
    msg,
    some(is.null, is.undefined, is.array, is.all.string)
  )
}
export const isOptString = (item: any) => {
  ...
  return compose(
    msg,
    some(is.null, is.undefined, is.string)
  )
}
export const isOptNumber = (item: any) => {
  ...
  return compose(
    msg,
    some(is.null, is.undefined, is.number)
  )
}
...
export const isOptCallback = (item: any) => {
  ...
  return compose(
    msg,
    some(is.null, is.undefined, is.function)
  )
}
export const isOptBoolean = (item: any) => {
  ...
  return compose(
    msg,
    some(is.null, is.undefined, is.boolean)
  )
}
