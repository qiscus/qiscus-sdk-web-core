...
const getMsg = (item: Record<string, unknown>, msg: unknown) => `\`${getName(item)}\` ${msg}`
...
export const isReqString = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.string)
  )
}
export const isReqNumber = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.number)
  )
}
export const isReqBoolean = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.boolean)
  )
}
export const isReqJson = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.object)
  )
}
export const isReqArrayNumber = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.array, allNumber)
  )
}
export const isReqArrayString = (item: any) => {
  ...
  return compose(
    msg,
    every(notNullOrUndefined, is.array, allString)
  )
}
...
export const isOptArrayNumber = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.array, allNumber)
  )
}
export const isOptArrayString = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.array, allString)
  )
}
export const isOptString = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.string)
  )
}
export const isOptNumber = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.number)
  )
}
export const isOptJson = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.object)
  )
}
export const isOptCallback = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.function_)
  )
}
export const isOptBoolean = (item: any) => {
  ...
  return compose(
    msg,
    some(is.nullOrUndefined, is.boolean)
  )
}
