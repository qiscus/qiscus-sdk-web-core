...
export const getMessageAdapterRaw = (s: Storage, api: Api.ApiRequester) => ({
  sendMessage(roomId: number, message: model.IQMessage): Promise<PostCommentResponse.RootObject> {
  ...
  markAsRead(roomId: number, messageId: number): Promise<UpdateCommentStatusResponse.RootObject> {
  ...
  markAsDelivered(roomId: number, messageId: number): Promise<UpdateCommentStatusResponse.RootObject> {
    return api.request<UpdateCommentStatusResponse.RootObject>(
      Api.updateCommentStatus({
        ...Provider.withBaseUrl(s),
        ...Provider.withCredentials(s),
  ...
  async searchMessages({
    ...
    page?: number
    limit?: number
  }): Promise<SearchMessagesV2Response.RootObject> {
    return api.request<SearchMessagesV2Response.RootObject>(
  ...
  async updateMessage(message: model.IQMessage): Promise<PostCommentResponse.RootObject> {
...
export declare module SearchMessagesV2Response {
  export interface Extras {}
